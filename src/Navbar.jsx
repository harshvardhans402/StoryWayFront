            ...
            <div className="mx-auto max-w-screen-xl px-6 lg:px-8 relative">
                <div className="relative flex h-16 space-x-10 w-full">
                    ...
                    <div className="flex-shrink-0 flex px-2 py-3 items-center space-x-8 flex-1 justify-end justify-self-end ">
                        <a className="px-4 py-1 bg-blue-500 text-white rounded-lg hover:bg-purple-600 transition duration-300">
                            Sign In
                        </a>
                        <a className="px-3 py-1 bg-blue-500 text-white rounded-lg hover:bg-purple-600 transition duration-300">
                            Sign Up
                        </a>
